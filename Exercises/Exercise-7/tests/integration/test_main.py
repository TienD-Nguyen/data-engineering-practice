...
2023-01-02,SN002,WD Blue SSD 500GB,500000000000,1
2023-01-03,SN003,Seagate Barracuda 2TB,2000000000000,0
2023-01-04,SN004,Samsung SSD 980,1000000000000,0
2023-01-05,SN005,Kingston NV2,250000000000,1"""
        
        # Create test ZIP file in data directory
        data_dir = os.path.join(temp_directory, "data")
        os.makedirs(data_dir)
        
        zip_path = os.path.join(data_dir, "drive_stats_2023-01-01.zip")
        with zipfile.ZipFile(zip_path, 'w') as zip_ref:
            zip_ref.writestr("2023-01-01.csv", realistic_csv_content)
